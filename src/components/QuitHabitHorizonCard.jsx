...
export default function QuitHabitHorizonCard({ horizon, color, selected, onClick }) {
  ...
  return (
    ...
    >
      <div className="hsim-hc-top">
        ...
        <span className="hsim-hc-gap qhab-hc-energy">+{horizon.afterEnergy}%</span>
      </div>
      <div className="hsim-hc-value">
        {formatTotal(horizon.totalHours)}
        <span className="hsim-hc-unit">hrs</span>
      </div>
      {horizon.insight?.line && (
